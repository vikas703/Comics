  ...
  return (
    <header className="header">
      <div className="nav_heading">
        <h1>
          <a href="#product" className="none1">
            COMICS.
          </a>
        </h1>
      </div>
      ...
      <div className="header1" ref={NavRef}>
        <span>
          <a href="#" className="none" onClick={showNavbar}>
            HOME
          </a>
        </span>
        <span>
          <a href="#about" className="none" onClick={showNavbar}>
            ABOUT
          </a>
        </span>
        <span>
          <a href="#product" className="none" onClick={showNavbar}>
            COMICS
          </a>
        </span>
